    ...
    Statement = [
      {
        ...
        Resource = ["arn:aws:s3:::${var.project}-${var.environment}-*", "arn:aws:s3:::${var.project}-${var.environment}-*/*"]
      }
    ]
  })
}
...
resource "aws_iam_role" "step_functions" {
  name = "${var.project}-${var.environment}-step-functions"
...
resource "aws_iam_role_policy" "eventbridge" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:states:*:*:stateMachine:${var.project}-${var.environment}-*"
    }]
  })
}
